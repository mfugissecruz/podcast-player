...
state(['episode' => function($number) {
    $episodes = collect(Episode::all()->toArray());
    return $episodes->where('number', $number)->first();
}]);
            ...
            <div class="flex items-center justify-between gap-8">
                <div>
                    ...
                    >
                        <p>
                            Released:
                            {{  \Carbon\Carbon::parse($episode['released_at'])->format('M j, Y') }}
                        </p>
                        &middot;
                        <p>
                            Duration:
